        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className={`w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center ring-2 shadow-sm border border-slate-200 transition-all ${currentView === View.PROFILE ? 'bg-rose-100 text-rose-600 ring-rose-200' : 'bg-slate-100 text-slate-500 ring-white hover:bg-white'}`}
              title="My Profile"
            >
