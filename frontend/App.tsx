...
const LandingPage: React.FC<{ onGetStarted: () => void; onNavigate: (view: View) => void }> = ({ onGetStarted, onNavigate }) => {
  return (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-xs sm:text-sm">
              <button onClick={() => onNavigate(View.PRIVACY_POLICY)} className="text-slate-500 hover:text-slate-700 transition-colors">
                Privacy Policy
              </button>
            ...
            {!detectionResult ? (
              ...
              <div className="flex-1 p-6 sm:p-8 flex flex-col h-full overflow-hidden">
                <div className="text-center mb-6 shrink-0">
                  ...
                  <div className="mb-4">
                    <span className={`inline-flex items-center px-4 py-1.5 rounded-full text-sm font-bold border ${detectionResult.score > 60 ? 'bg-rose-50 text-rose-700 border-rose-100' :
          ...
          <div className="flex flex-wrap lg:flex-nowrap items-center justify-between gap-2 sm:gap-3">
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto overflow-x-auto no-scrollbar pb-1 sm:pb-0">
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all h-10 ${showAdvanced
            ...
            <div className="pt-2 pb-1 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-in slide-in-from-top-1">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full h-1.5 bg-slate-200 rounded-full appearance-none accent-rose-600 ${!userState.isPremium && intensity >= 70 ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'
                    }`}
                />
      ...
      {(view !== View.LANDING && view !== View.AUTH && view !== View.VERIFY_EMAIL && view !== View.RESET_PASSWORD && view !== View.PAYMENT_SUCCESS && view !== View.PRIVACY_POLICY && view !== View.TERMS_CONDITIONS && view !== View.SUPPORT && view !== View.ADMIN_DASHBOARD) && (
        <>
          ...
          <main className="flex-1 bg-slate-50 relative">
            ...
            {view === View.PRICING && <Pricing onSubscribe={handleSubscribe} onPaymentSuccess={handlePaymentSuccess} isPremium={userState.isPremium} userId={userState.user?.id} userEmail={userState.user?.email} userName={userState.user?.name} />}
            {view === View.HISTORY && (
