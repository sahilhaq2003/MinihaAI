...
export const QRPayment: React.FC<QRPaymentProps> = ({ isOpen, onClose, amount, userId, userEmail, userName, onPaymentSuccess }) => {
  ...
  const handleSubmitPayment = async () => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/payment/request`, {
        method: 'POST',
